package com.oracle.oradocs.images;
...
import com.oracle.oradocs.folders.FolderVO;

import jdk.nashorn.internal.parser.JSONParser;

public class OraDocsImagesDownload {
	...
	private static Log oraDoclogger = LogFactory.getLog(OraDocsImagesDownload.class);
	
	private List<FileVO> updatedFiles = new ArrayList<>();
	
	private String token = "";
	
	public OraDocsImagesDownload(String token, String MasterFolder) {
		this.token = token;
	...
	/*	new OraDocsFolders(
		...
		new OraDocsImagesDownload(
				"eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsIng1dCI6InUwY1BSU3dCYkE3V1BkZGR1MGo2QlBfRXZxVSIsImtpZCI6ImNvcnAuY2VydCJ9..LsI83p-EhOvekub1UJ0EL6PFySn3w6Q5qHRe184NlHQWr704wsOFgowfnmlAuMypsCOfPPEqnYk065dkESr-FdpCn4lhxn7sIXlikgZ3u_SlpUh-dvsDpgJdE29cWS4H3o8lX-6e-P6uUkHHZd0Tk4Ha73nJo_Cjx80YPPMfjKPMS1T0BHYvJp8T_qCkqlInpjFnWrgueOLb17UjU8PdWvTf7sPtrDzT4mR59_nGyVL69hxd2A1ZcAGXKHmEBzJSsrHtmYFroqCaqeOWoLNJPWSnsQj7MprmcI-SN60IiVX957h2y7e3QB-MWhqsuguB4ACOEjWT4r3DPrptdodRwQ",
				"F549148E379658387C83D36EF6C3FF17C1177A968060").flowOrganizer();
	...
	private List<FolderVO> oraDocsJsonParser(String data) {
		...
		if (size > 0) {
			String folder_Name = (String) jsonObject.get("name");
			...
			while (iterator.hasNext()) {
				...
				if (folders.get("type").equals("folder")) {
					...
					fileVo.setFolder_name(folder_Name);
	...
	private List<FileVO> downloadFiles(List<FileVO> files) {
		...
		for (FileVO file : files) {
			...
			try {
				...
				if((file.getFile_name().contains(".jpg"))||(file.getFile_name().contains(".jpeg"))||(file.getFile_name().contains(".svg"))||(file.getFile_name().contains(".png"))) {
					oraDoclogger.info("Downloading Files --->" + file.getFile_name());
					//previewImageFiles(file.getFile_id());
					storeDownloadedFiles(file);
					img++;
				}
			} catch (IOException e) {
...
private List<FileVO> preViewFiles(List<FileVO> files) {
		for (FileVO file : files) {
			try {
				
				if((file.getFile_name().contains(".jpg"))||(file.getFile_name().contains(".jpeg"))||(file.getFile_name().contains(".svg"))||(file.getFile_name().contains(".png"))) {
					oraDoclogger.info("Downloading Files --->" + file.getFile_name());
					String response_json = previewImageFiles(file.getFile_id());;
	...
	private void storeDownloadedFiles(FileVO filaa) throws ClientProtocolException, IOException {
		
		//String fileID = "DCEF68D6049E2E1DAADB81A8F6C3FF17C1177A968060";
		File file = null;

		HttpClient client = new DefaultHttpClient();
		HttpGet request = new HttpGet(DOWNLOADFILEURL+filaa.getFile_id()+"/data" );
		...
		/*if(filaa.getFolder_name().equalsIgnoreCase("Community")) {
			 file = new File("D:\\Git_Phani\\OraDocs_I\\WebContent\\downloadeImages\\community\\"+filaa.getFolder_name()+"_"+filaa.getFile_name());
		}else if(filaa.getFolder_name().equalsIgnoreCase("Customer")) {
			 file = new File("D:\\Git_Phani\\OraDocs_I\\WebContent\\downloadeImages\\customers\\"+filaa.getFolder_name()+"_"+filaa.getFile_name());
		}else if(filaa.getFolder_name().equalsIgnoreCase("People")) {
			 file = new File("D:\\Git_Phani\\OraDocs_I\\WebContent\\downloadeImages\\people\\"+filaa.getFolder_name()+"_"+filaa.getFile_name());
		}*/
		 
		file = new File("D:\\Git_Phani\\OraDocs_I\\WebContent\\downloadeImages\\"+filaa.getFolder_name()+"_"+filaa.getFile_name());
...
private String previewImageFiles(String fileID) throws ClientProtocolException, IOException {
